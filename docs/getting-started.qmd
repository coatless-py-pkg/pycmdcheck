...
You'll see output like (abbreviated — a default run executes every enabled check):
...
pycmdcheck ships the following built-in checks (run `pycmdcheck --list` for the
authoritative, up-to-date set):
