...
::: {.callout-note}
pycmdcheck is not yet published to PyPI. Install it directly from GitHub for
now. Once it is released, `pip install pycmdcheck` will work too.
:::
...
matching extra when installing. For a GitHub install, the extra goes in the
PEP 508 `pycmdcheck[extra] @ <url>` form:
